...
const ItProgram = ({ data }: ItProgramProps) => {
      ...
      <div className="max-w-[1260px] mx-auto">
          ...
          {data.values.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="rounded-[24px] card-hover2  duration-700 border flex sm:flex-row flex-col gap-6 border-[#F1F5F9] bg-white px-6 py-8"
              >
                {/* Icon */}
              <div className="">
  ...
  <path d="M7.50032 18.3337H12.5003C16.667 18.3337 18.3337 16.667 18.3337 12.5003V7.50032C18.3337 3.33366 16.667 1.66699 12.5003 1.66699H7.50032C3.33366 1.66699 1.66699 3.33366 1.66699 7.50032V12.5003C1.66699 16.667 3.33366 18.3337 7.50032 18.3337Z" stroke="#F36A10" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M6.45801 9.99994L8.81634 12.3583L13.5413 7.6416" stroke="#F36A10" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                      {point}
                    </li>
                  ))}
