    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-[120px] bg-[#FFFAF5]">
      <div className="max-w-[1362px]  mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <span className="text-[#F36A10] text-xs sm:text-sm font-semibold uppercase tracking-widest">Testimonial</span>
        </div>
        ...
        <div className="relative">
          ...
          <div className=" rounded-lg md:rounded-2xl p-6 sm:p-8 md:p-12 ">
            <div className="grid grid-cols-1 md:grid-cols-2  max-w-[1074px] items-center">
             
                <div
                  className="relative w-52 sm:w-64 md:w-80 lg:w-96 rounded-lg md:rounded-xl border-4 md:border-6 border-[#F36A10] overflow-hidden z-10 mx-auto"
              ...
              <div className="order-2 md:order-2 flex flex-col">
                ...
                {/* Quote Text */}
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-[#1A1A1A] font-medium leading-relaxed mb-6 sm:mb-8 text-pretty">
                  {current.quote}
                </p>
                ...
                {/* Client Role */}
                <p className="text-sm sm:text-base md:text-lg text-[#6F7377] font-medium">{current.role}</p>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="absolute -left-6 sm:-left-8 md:-left-12 top-1/2 -translate-y-1/2 w-10 sm:w-12 md:w-16 h-10 sm:h-12 md:h-16 rounded-full border-2 md:border-3 border-[#F36A10] flex items-center justify-center hover:bg-[#F36A10] hover:text-white transition-all duration-300 bg-white text-[#F36A10] z-20"
          ...
          >
            <svg
              ...
              viewBox="0 0 28 22"
              fill="none"
              className="sm:w-6 sm:h-5 md:w-7 md:h-6"
            >
              <path
          ...
          <button
            onClick={goToNext}
            className="absolute -right-6 sm:-right-8 md:-right-12 top-1/2 -translate-y-1/2 w-10 sm:w-12 md:w-16 h-10 sm:h-12 md:h-16 rounded-full border-2 md:border-3 border-[#F36A10] flex items-center justify-center hover:bg-[#F36A10] hover:text-white transition-all duration-300 bg-[#F36A10] text-white z-20"
